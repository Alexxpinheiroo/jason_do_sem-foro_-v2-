...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-8 right-8 w-16 h-16 bg-[#25d366] rounded-full flex items-center justify-center shadow-[0_10px_20px_rgba(37,211,102,0.3)] z-50 transition-colors hover:bg-[#128c7e] group"
      title="Fale com o Jason no WhatsApp"
    >
      <img src="input_file_11.png" alt="WhatsApp" className="w-10 h-10 object-contain" />
